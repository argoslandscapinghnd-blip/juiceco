...
//  Muestra usuario, sucursal y botón cerrar sesión
// ─────────────────────────────────────────────
...
export default function CajeroHeader({ usuario, sucursal, tieneItems, onCerrarSesion }: Props) {
  ...
  if (confirmar) {
    return (
      <div style={{
        ...
        <div style={{ ...cardStyle, maxWidth: 400, width: "100%", textAlign: "center", padding: "32px 24px" }}>
          ...
          <button
            ...
            style={{ width: "100%", padding: 14, borderRadius: 10, border: "none", background: colors.danger, color: "white", fontWeight: "bold", fontSize: 15, cursor: "pointer", marginBottom: 10 }}
          >
            SÍ, CERRAR SESIÓN
          </button>
          <button
            onClick={() => setConfirmar(false)}
            style={{ width: "100%", padding: 14, borderRadius: 10, border: `1px solid ${colors.border}`, background: "white", fontWeight: "bold", fontSize: 15, cursor: "pointer" }}
          >
            CANCELAR
          </button>
        </div>
